 ...
 * @author xvr
 */
public class GUIDevolucion4 extends javax.swing.JFrame {
...
//            ((JSpinner) pCantidad1.getComponent(i)).setEnabled(false);            
//        }
//        
...
//            ((JComboBox) pPrecio1.getComponent(i)).setEnabled(false);
//        }
    ...
    public void renovar() {
        ...
        for (int i = 1; i < pCantidad1.getComponentCount(); i++) {
            ((JSpinner) pCantidad1.getComponent(i)).setValue(0);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIDevolucion4().setVisible(true);
            }
        });
    }
